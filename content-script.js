// TODO: now do *mousedown* and mouseup, taking care to manage interactions with onclick appropriately
(() => {
    ...
    let MOUSE_STATIONARY_MS = GRACE_PERIOD_CYCLES * UPDATE_DELAY_MS  // TODO: should really be the same as grace period?
            ...
            if (!pauseOnPage) {
                ...
                hoverElems.forEach(elem => {
                    ...
                    if (!elem._hasOnclickInterceptor) {
                        if (elem.onclick || elem.href) {
                            // Overriding click events also prevents <a href="..."> from being followed!
